...
SVC_NAME=`systemd-escape --path "vsts.agent.devjohnmogi1.Default.john-Z370P-D3.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (devjohnmogi1.Default.john-Z370P-D3)"
